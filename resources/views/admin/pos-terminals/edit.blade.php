...
@section('page_title', 'Edit Terminal Kasir')
...
@section('content')
    <div class="space-y-6">
                ...
                <div class="relative flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p class="mt-2 max-w-2xl text-sm font-medium leading-relaxed text-[#F7F6F4]/80">
                            Perbarui informasi terminal {{ $terminal->nama_terminal }}.
                        </p>
                    </div>
        ...
        @include('admin.pos-terminals._form', [
            'terminal' => $terminal,
            'action' => route('admin.pos-terminals.update', $terminal),
            'method' => 'PUT',
