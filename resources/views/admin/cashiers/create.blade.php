...
@section('content')
    <div class="space-y-6">
                ...
                <div class="relative flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
                    <div>
                        ...
                        <p class="mt-2 max-w-2xl text-sm font-medium leading-relaxed text-[#F7F6F4]/80">
                            Kasir baru otomatis aktif dan password default adalah rotimaroshikmah111.
                        </p>
                    </div>
        ...
        @include('admin.cashiers._form', [
            'action' => route('admin.cashiers.store'),
            'method' => 'POST',
            'submitLabel' => 'Simpan Kasir',
            'showStatus' => false,
        ])
    </div>
@endsection
